...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.btn7.setFont(QtGui.QFont(myFont, 9))
        ...
        self.btn8.setFont(QtGui.QFont(myFont, 9))
        ...
        self.btn6.clicked.connect(self.settings)
        self.btn8.clicked.connect(self.about)
...
class aboutWindow(QScrollArea):
    ...
    def __init__(self):
        ...
        specificationTable.setRowCount(8)
        specificationTable.setColumnCount(2)
        specificationTable.setFixedSize(285,300)
        ...
        specificationTable.setItem(5,0,QTableWidgetItem("Operating Time (on Load)"))
        specificationTable.setItem(5,1,QTableWidgetItem("15 Mins"))
